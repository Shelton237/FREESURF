...
<template>
  <div class="p-6 max-w-2xl">
    <h1 class="text-2xl font-semibold mb-4">Créer une intervention</h1>
    <div class="grid gap-3">
      ...
      <div>
        <label class="block text-sm">Planifiée le</label>
      ...
      <button class="px-4 py-2 bg-red-600 text-white rounded" @click="submit">Créer</button>
    </div>
  </div>
</template>
